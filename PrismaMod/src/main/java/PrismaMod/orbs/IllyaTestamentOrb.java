...
public class IllyaTestamentOrb extends AbstractOrb {

    // Standard ID/Description
    public static final String ORB_ID = DefaultMod.makeID("IllyaTestamentOrb");
    private static final OrbStrings orbString = CardCrawlGame.languagePack.getOrbString(ORB_ID);
    public static final String[] DESC = orbString.DESCRIPTION;

    private static final Texture IMG = TextureLoader.getTexture(makeOrbPath("Testament_orb.png"));
    ...
    public void onEvoke() {
        ...
        AbstractDungeon.player.gainEnergy(evokeAmount);
    ...
    public void onEndOfTurn() {
        ...
        DamageInfo info = new DamageInfo(p, passiveAmount);

        AbstractDungeon.actionManager.addToTop(new DamageAction(p, info));
    ...
    public void render(SpriteBatch sb) {
        sb.setColor(new Color(0.58f, 0.0f, 0.7f, c.a / 2.0f));
        sb.draw(img, cX - 48.0f, cY - 48.0f + bobEffect.y, 48.0f, 48.0f, 96.0f, 96.0f, scale + MathUtils.sin(angle / PI_4) * ORB_WAVY_DIST * Settings.scale, scale, angle, 0, 0, 96, 96, false, false);
        sb.setColor(new Color(1.0f, 0.0f, 1.0f, this.c.a / 2.0f));

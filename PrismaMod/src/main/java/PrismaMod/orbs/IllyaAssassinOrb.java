...
public class IllyaAssassinOrb extends AbstractOrb {

    // Standard ID/Description
    public static final String ORB_ID = DefaultMod.makeID("IllyaAssassinOrb");
    private static final OrbStrings orbString = CardCrawlGame.languagePack.getOrbString(ORB_ID);
    public static final String[] DESC = orbString.DESCRIPTION;

    private static final Texture IMG = TextureLoader.getTexture(makeOrbPath("Assassin_orb.png"));
    ...
    @Override
    public void onEvoke() {
        AbstractDungeon.actionManager.addToBottom(new MakeTempCardInHandAction(new Shiv(), evokeAmount));
    ...
    public void onStartOfTurn() {
        ...
        AbstractDungeon.actionManager.addToTop(new MakeTempCardInHandAction(new Shiv(), passiveAmount));
    }
    ...
    public void render(SpriteBatch sb) {
        sb.setColor(new Color(0.2f, 0.2f, 0.2f, c.a / 2.0f));
        sb.draw(img, cX - 48.0f, cY - 48.0f + bobEffect.y, 48.0f, 48.0f, 96.0f, 96.0f, scale + MathUtils.sin(angle / PI_4) * ORB_WAVY_DIST * Settings.scale, scale, angle, 0, 0, 96, 96, false, false);
        sb.setColor(new Color(0.6f, 0.6f, 0.6f, this.c.a / 2.0f));

...
//Heal enemy 3 hp per turn
//Evoke heal self 5 hp
...
public class MiyuHealOrb extends AbstractOrb {

    // Standard ID/Description
    public static final String ORB_ID = DefaultMod.makeID("MiyuHealOrb");
    ...
    public void applyFocus() {
        if(AbstractDungeon.player.hasPower(FocusPower.POWER_ID)) {
            //this.evokeAmount = 10 + (AbstractDungeon.player.getPower(FocusPower.POWER_ID).amount-1);
            this.passiveAmount = 0 + (AbstractDungeon.player.getPower(FocusPower.POWER_ID).amount-1);
            //updateDescription();
        } else {
            //evokeAmount = baseEvokeAmount = 5;
            passiveAmount = basePassiveAmount = 3;
    ...
    public void onEvoke() {
        ...
        AbstractDungeon.actionManager.addToTop(new HealAction(p, p, evokeAmount));
    ...
    public void onStartOfTurn() {
        ...
        AbstractDungeon.actionManager.addToTop(new HealAction(m, m, passiveAmount));
    }
    ...
    public void render(SpriteBatch sb) {
        sb.setColor(new Color(0.5f, 0.9f, 0.5f, c.a / 2.0f));
        sb.draw(img, cX - 48.0f, cY - 48.0f + bobEffect.y, 48.0f, 48.0f, 96.0f, 96.0f, scale + MathUtils.sin(angle / PI_4) * ORB_WAVY_DIST * Settings.scale, scale, angle, 0, 0, 96, 96, false, false);
        sb.setColor(new Color(0.0f, 0.3f, 0.0f, this.c.a / 2.0f));

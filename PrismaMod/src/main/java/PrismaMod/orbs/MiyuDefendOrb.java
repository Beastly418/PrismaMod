...
//Evoke gain 1 dexterity
//Passive gain 4 block to self
...
public class MiyuDefendOrb extends AbstractOrb {

    // Standard ID/Description
    public static final String ORB_ID = DefaultMod.makeID("MiyuDefendOrb");
    ...
    public void onEvoke() {
        ...
        AbstractDungeon.actionManager.addToTop(new ApplyPowerAction(p, p, new DexterityPower(p, evokeAmount)));
    ...
    public void render(SpriteBatch sb) {
        sb.setColor(new Color(0.51f, 0.54f, 0.59f, c.a / 2.0f));
        ...
        sb.setColor(new Color(0.73f, 0.71f, 0.83f, this.c.a / 2.0f));

...
public class MiyuWeakOrb extends AbstractOrb {

    // Standard ID/Description
    public static final String ORB_ID = DefaultMod.makeID("MiyuWeakOrb");
    ...
    public void onEvoke() {
        for(AbstractMonster m : AbstractDungeon.getMonsters().monsters) {
            AbstractDungeon.actionManager.addToTop(new ApplyPowerAction(m, m, new WeakPower(m, evokeAmount, false)));
        }
    ...
    public void onStartOfTurn() {
        ...
        AbstractDungeon.actionManager.addToTop(new ApplyPowerAction(m, m, new WeakPower(m, passiveAmount, false)));
    ...
    public void render(SpriteBatch sb) {
        sb.setColor(new Color(0.40f, 1.0f, 0.60f, c.a / 2.0f));
        sb.draw(img, cX - 48.0f, cY - 48.0f + bobEffect.y, 48.0f, 48.0f, 96.0f, 96.0f, scale + MathUtils.sin(angle / PI_4) * ORB_WAVY_DIST * Settings.scale, scale, angle, 0, 0, 96, 96, false, false);
        sb.setColor(new Color(0.0f, 0.3f, 0.1f, this.c.a / 2.0f));

...
//Evoke Apply 1 weak to all
//Passive Apply 1 weak to random enemy
...
public class MiyuVulOrb extends AbstractOrb {

    // Standard ID/Description
    public static final String ORB_ID = DefaultMod.makeID("MiyuVulOrb");
    ...
    public void onEvoke() {
        for(AbstractMonster m : AbstractDungeon.getMonsters().monsters) {
            AbstractDungeon.actionManager.addToTop(new ApplyPowerAction(m, m, new VulnerablePower(m, evokeAmount, false)));
        }
    ...
    public void onStartOfTurn() {
        ...
        AbstractDungeon.actionManager.addToTop(new ApplyPowerAction(m, m, new VulnerablePower(m, passiveAmount, false)));
    ...
    public void render(SpriteBatch sb) {
        sb.setColor(new Color(1.00f,0.20f,0.87f, c.a / 2.0f));
        sb.draw(img, cX - 48.0f, cY - 48.0f + bobEffect.y, 48.0f, 48.0f, 96.0f, 96.0f, scale + MathUtils.sin(angle / PI_4) * ORB_WAVY_DIST * Settings.scale, scale, angle, 0, 0, 96, 96, false, false);
        sb.setColor(new Color(0.3f, 0.0f, 0.0f, this.c.a / 2.0f));

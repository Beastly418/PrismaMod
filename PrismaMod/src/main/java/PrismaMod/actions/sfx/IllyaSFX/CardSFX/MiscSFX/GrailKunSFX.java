...
public class GrailKunSFX extends AbstractSFX {
    ...
    public picture pic;
    public GrailKunSFX(AbstractCreature target){
        this.img = TextureLoader.getTexture(makeSFXPath("GrailKun.png"));// 23
        this.color = new Color(1, 1, 1, 0);// 24
        this.scale = .8F * Settings.scale;// 29
        this.target = target;
        ...
        this.x = Settings.WIDTH - img.getWidth()*2*scale;

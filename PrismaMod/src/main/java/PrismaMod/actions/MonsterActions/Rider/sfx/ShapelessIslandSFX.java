package PrismaMod.actions.MonsterActions.Rider.sfx;
...
public class ShapelessIslandSFX extends AbstractMonsterSFX {

    public AbstractPrismaMonster m;
    public AbstractPlayer target;

    public ShapelessIslandSFX(AbstractPrismaMonster m, AbstractPlayer target){
        this.m = m;
        this.target = target;

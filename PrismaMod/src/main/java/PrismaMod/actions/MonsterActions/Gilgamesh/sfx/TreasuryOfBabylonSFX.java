package PrismaMod.actions.MonsterActions.Gilgamesh.sfx;
...
public class TreasuryOfBabylonSFX extends AbstractMonsterSFX {

    public AbstractPrismaMonster m;
    public AbstractPlayer target;

    public TreasuryOfBabylonSFX(AbstractPrismaMonster m, AbstractPlayer target){
        this.m = m;
        this.target = target;

        this.images.add(new picture(makeSFXPath("All_Suits.png")));    //<<< NEED TO MAKE THESE FOLDERS STILL DONT FORGET IDIOT!!!!

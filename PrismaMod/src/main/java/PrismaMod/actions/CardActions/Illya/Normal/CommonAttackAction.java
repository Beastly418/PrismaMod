...
public class CommonAttackAction extends AbstractCardAction {
    ...
    public boolean hit;
    public CommonAttackAction(AbstractPlayer p, AbstractCreature target, int damage, DamageInfo.DamageType damageType){
        this.p = p;

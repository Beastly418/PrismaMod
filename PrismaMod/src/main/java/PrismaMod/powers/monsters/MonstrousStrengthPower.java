...
@Deprecated
public class MonstrousStrengthPower extends AbstractMonsterPower {

    public AbstractCreature source;

    public static final String POWER_ID = DefaultMod.makeID("MonstrousStrengthPower");
    ...
    public MonstrousStrengthPower(final AbstractCreature owner, final AbstractCreature source, final int amount){
        name = NAME;
        ID = POWER_ID;

...
public class IllyaShielderPower extends AbstractInstallPower {
    ...
    public static final String POWER_ID = DefaultMod.makeID("IllyaShielderPower");
    ...
    private static final Texture tex84 = TextureLoader.getTexture("PrismaModResources/images/powers/Shielder_power84.png");
    private static final Texture tex32 = TextureLoader.getTexture("PrismaModResources/images/powers/Shielder_power32.png");

    public IllyaShielderPower(final AbstractCreature owner, final AbstractCreature source, final int amount, IllyaInstallObj install) {
        name = NAME;
        ID = POWER_ID;
        ...
        BLOCK = this.install.getBlockPerTurn();

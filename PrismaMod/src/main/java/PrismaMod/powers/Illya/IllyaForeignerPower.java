...
public class IllyaForeignerPower extends AbstractInstallPower {
    ...
    public static final String POWER_ID = DefaultMod.makeID("IllyaForeignerPower");
    ...
    private static final Texture tex84 = TextureLoader.getTexture("PrismaModResources/images/powers/Foreigner_power84.png");
    private static final Texture tex32 = TextureLoader.getTexture("PrismaModResources/images/powers/Foreigner_power32.png");

    public IllyaForeignerPower(final AbstractCreature owner, final AbstractCreature source, final int amount, IllyaInstallObj install) {
        name = NAME;
        ID = POWER_ID;
    ...
    public AbstractPower makeCopy() {
        return new IllyaForeignerPower(owner, source, amount, install);
    }

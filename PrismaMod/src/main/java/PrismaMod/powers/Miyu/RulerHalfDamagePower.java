...
public class RulerHalfDamagePower extends AbstractInstallPower {
    ...
    public static final String POWER_ID = DefaultMod.makeID("RulerHalfDamagePower");
    ...
    public RulerHalfDamagePower(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        name = NAME;
        ID = POWER_ID;
    ...
    public AbstractPower makeCopy() {
        return new RulerHalfDamagePower(owner, source, amount);
    }

...
public class MiyuAttackChannelAttack extends AbstractDynamicCard {
    public static final String ID = DefaultMod.makeID(MiyuAttackChannelAttack.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("Miyu/AttackChannelAttack.png");
    ...
    public MiyuAttackChannelAttack() {

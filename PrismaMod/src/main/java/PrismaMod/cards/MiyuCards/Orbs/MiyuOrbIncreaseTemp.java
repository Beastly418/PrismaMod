...
@Deprecated
public class MiyuOrbIncreaseTemp extends AbstractDynamicCard {
    public static final String ID = DefaultMod.makeID(MiyuOrbIncreaseTemp.class.getSimpleName());

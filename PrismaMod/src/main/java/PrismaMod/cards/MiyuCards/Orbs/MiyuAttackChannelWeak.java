...
public class MiyuAttackChannelWeak extends AbstractDynamicCard {
    public static final String ID = DefaultMod.makeID(MiyuAttackChannelWeak.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("Miyu/AttackChannelWeak.png");

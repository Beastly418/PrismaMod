...
//Channel all defend orbs
public class IllyaUberDefendChannel extends CustomCard {

    public static final String ID = DefaultMod.makeID(IllyaUberDefendChannel.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("Illya/UberDefendChannel.png");

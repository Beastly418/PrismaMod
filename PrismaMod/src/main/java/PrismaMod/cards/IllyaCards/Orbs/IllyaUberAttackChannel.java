...
//Channel all attack orbs
public class IllyaUberAttackChannel extends CustomCard {

    public static final String ID = DefaultMod.makeID(IllyaUberAttackChannel.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("Illya/UberAttackChannel.png");

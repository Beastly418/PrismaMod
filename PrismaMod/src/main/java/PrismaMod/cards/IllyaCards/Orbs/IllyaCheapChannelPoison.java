...
public class IllyaCheapChannelPoison extends CustomCard {


    // TEXT DECLARATION

    public static final String ID = DefaultMod.makeID(IllyaCheapChannelPoison.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("Illya/CheapChannelPoison.png");
    ...
    public IllyaCheapChannelPoison() {

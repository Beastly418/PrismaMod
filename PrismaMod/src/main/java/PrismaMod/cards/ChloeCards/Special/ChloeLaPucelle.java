...
public class ChloeLaPucelle extends AbstractDynamicCard {
    public static final String ID = DefaultMod.makeID(ChloeLaPucelle.class.getSimpleName());

...
public class ChloeExhaustTwo extends AbstractDynamicCard {
    public static final String ID = DefaultMod.makeID(ChloeExhaustTwo.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("Chloe/ChloeChibi.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToTop(new ExhaustCardFromGridSelectAction(p, p.drawPile, this.magicNumber, "", 2));
    }

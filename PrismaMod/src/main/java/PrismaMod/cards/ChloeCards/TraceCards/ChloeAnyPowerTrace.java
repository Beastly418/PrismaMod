...
public class ChloeAnyPowerTrace extends AbstractTraceCard {
    public static final String ID = DefaultMod.makeID(ChloeAnyPowerTrace.class.getSimpleName());
    ...
    private CardType fakeType = CardType.POWER;
    ...
    private void getCards() {
        ...
        for (Map.Entry<String, AbstractCard> c : CardLibrary.cards.entrySet()) {
            if (c.getValue().type == this.fakeType && !(c.getValue() instanceof AbstractTraceCard) && !(c.getValue().color == InstallColorEnum.COLOR_INSTALL)) {

...
public class ChloeAnyAttackTrace extends AbstractTraceCard {
    public static final String ID = DefaultMod.makeID(ChloeAnyAttackTrace.class.getSimpleName());
    ...
    private CardType fakeType = CardType.ATTACK;

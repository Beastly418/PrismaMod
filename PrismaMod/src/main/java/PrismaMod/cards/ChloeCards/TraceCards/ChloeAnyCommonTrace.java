...
public class ChloeAnyCommonTrace extends AbstractTraceCard {
    public static final String ID = DefaultMod.makeID(ChloeAnyCommonTrace.class.getSimpleName());
    ...
    private CardRarity fakeRarity = CardRarity.COMMON;

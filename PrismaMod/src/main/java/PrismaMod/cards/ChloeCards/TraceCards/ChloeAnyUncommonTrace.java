...
public class ChloeAnyUncommonTrace extends AbstractTraceCard {
    public static final String ID = DefaultMod.makeID(ChloeAnyUncommonTrace.class.getSimpleName());
    ...
    private CardRarity fakeRarity = CardRarity.UNCOMMON;
    ...
    private void getCards() {
        ...
        for (Map.Entry<String, AbstractCard> c : CardLibrary.cards.entrySet()) {
            if (c.getValue().rarity == this.fakeRarity && !(c.getValue() instanceof AbstractTraceCard)) {
